-- ============================================================================
-- 0176_distribution_social_channels
--
-- Adds social distribution vehicles as first-class tracked channels. These are
-- guided/concierge channels, not silent API posting.
-- ============================================================================
...
begin
  ...
  if v_post is null and p_source_hint = 'network' then
...
grant execute on function
  public.submit_public_lead(uuid, text, text, text, date, text, uuid, integer, integer, boolean, text, jsonb, boolean, text)
