-- 0154_clustering_respect_windows.sql
-- S506: clustering narrows only inside operator-opened windows. Anchored
-- closed days stay closed in both write RPCs. No schema change.
