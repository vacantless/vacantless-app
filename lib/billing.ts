...
// gets the print-yourself N1 from the rent-increase card (the upgrade hook).
export function canUseServeNotice(plan: string | null | undefined): boolean {
  return hasEntitlement(plan, "serve_notice");
}
