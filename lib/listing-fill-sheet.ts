...
const RENTFASTER_STEP = {
  ...
  content: "Step 3 · Description, features & contact",
  payment: "Step 4 · Package, add-ons & payment",
  afterPayment: "Step 5 · Photos, syndication & proof",
} as const;
...
function rentFasterFields(input: FillSheetInput, title: string, body: string): FillField[] {
  ...
  return [
    ...
    },
    {
      ...
      source: "listing",
      step: RENTFASTER_STEP.address,
      hint: "Pick the Google autocomplete/geocode result and confirm the listing lands in the correct city search.",
      guardrailId: "rentfaster-address-autocomplete",
    },
    {
      id: "rentfaster-province",
      label: "Province",
      value: "Ontario",
      source: "preset",
      step: RENTFASTER_STEP.address,
      hint: "RentFaster can default west; set the province to Ontario before searching the address.",
      guardrailId: "rentfaster-province-default",
    },
    {
      id: "rentfaster-community",
      label: "Community / city",
      value: null,
      source: "manual",
      step: RENTFASTER_STEP.address,
      hint: "Confirm the city/community after the address suggestion is selected.",
    ...
    },
    {
      ...
      label: "Review property type",
      value: "Fourplex (review)",
      source: "preset",
      step: RENTFASTER_STEP.details,
      hint: "RentFaster Single Unit has no generic Apartment option. For a unit in a fourplex, choose Fourplex; otherwise pick the closest real type.",
      guardrailId: "rentfaster-property-type-review",
    },
    {
      id: "rentfaster-title",
      label: "Ad title",
    ...
    },
    {
      ...
      value: body,
      source: "listing",
      step: RENTFASTER_STEP.content,
      hint: "The ad includes unlimited description, so keep the useful details in.",
      guardrailId: "rentfaster-photo-depth",
    },
    {
      id: "rentfaster-home-features",
      label: "Home features",
      value: null,
      source: "manual",
      step: RENTFASTER_STEP.content,
      hint: "Use the inline Add Feature picker for washer/dryer, A/C, parking, utilities, and other real features.",
      guardrailId: "rentfaster-home-features-picker",
    },
    {
      ...
      source: "listing",
      step: RENTFASTER_STEP.content,
      hint: "Confirm this is the inbox you want RentFaster inquiries to reach.",
      guardrailId: "rentfaster-contact-methods",
    },
    {
      ...
      source: "listing",
      step: RENTFASTER_STEP.content,
      hint: "Confirm the public phone number before payment.",
      guardrailId: "rentfaster-contact-methods",
    },
    {
      id: "rentfaster-payment",
      label: "Package / payment",
      value: "Single Unit Listing package - confirm current checkout total, term, and add-ons",
      source: "preset",
      step: RENTFASTER_STEP.payment,
      hint: "Review the Single Unit package, uncheck Credit Report or Zumper/PadMapper add-ons unless you truly want them, then pay only after the total is right.",
      guardrailId: "rentfaster-package-addons",
    },
    {
      id: "rentfaster-promotion",
      label: "Paid promotion",
      value: null,
      source: "manual",
      step: RENTFASTER_STEP.payment,
      hint: "Paid promotion is not automatic. Leave it off unless the owner approved the extra spend.",
      guardrailId: "rentfaster-promotion-not-auto",
    },
    {
      ...
      value: null,
      source: "manual",
      step: RENTFASTER_STEP.afterPayment,
      hint: "RentFaster only exposes the photo upload after payment. Upload the full unit-specific set once checkout is complete.",
      guardrailId: "rentfaster-photos-after-payment",
    },
    {
      id: "rentfaster-downstream-syndication",
      label: "Downstream syndication",
      value: "Rentals.ca, RentBoard, RentCanada via RentFaster; Zumper/PadMapper only if the add-on is chosen",
      source: "preset",
      step: RENTFASTER_STEP.afterPayment,
      hint: "Treat this as RentFaster's own syndication claim. Vacantless still counts the channel live only after the public ad URL is pasted.",
      guardrailId: "rentfaster-downstream-syndication",
    },
    {
      ...
      guardrailId: "rentfaster-proof-capture",
    },
  ];
}
