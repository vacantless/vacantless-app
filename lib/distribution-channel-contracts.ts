...
const CONTRACT_OVERRIDES: Record<PublishChannelKey, ContractOverride> = {
  ...
  spacelist: {
    ...
    takedownKind: "operator_task",
    rolloutState: "planned",
    note: "Commercial-only candidate. Source packet is modeled; connected posting and proof behavior remain a later gate.",
  },
  costar_loopnet: {
    executionKind: "fallback",
    accountKind: "none",
    ...
    takedownKind: "operator_task",
    rolloutState: "planned",
    note: "CoStar/LoopNet CRE and 5+ multifamily lane stays operator-assisted until account, verification, price, and proof behavior are proven.",
  },
  realtor_ca: {
