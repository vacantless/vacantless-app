...
export const PORTAL_REQUIREMENTS: readonly PortalRequirements[] = [
  ...
  },
  {
    ...
    sourceRefs: [
      ...
      "https://help.spacelist.ca/hc/en-us/articles/360000439103-How-do-I-list-an-entire-building",
      "https://help.spacelist.ca/hc/en-us/articles/360000569706-How-do-I-display-my-listings-on-my-own-website",
    ],
    ...
    operatorSteps: [
      ...
      "Review lease rate, available area, photos, contact details, and listing proof before publishing.",
      "Save the public SpaceList listing URL back into Vacantless.",
    ],
    topUps: ["SpaceList Pro or Engine, only with explicit approval"],
    proofRequired: true,
    liveProofLabel: "SpaceList public listing URL",
    notes: [
      "SpaceList publicly positions itself as a Canadian commercial marketplace and says listing, browsing, and inquiring are free.",
      "The authenticated listing flow still needs a no-submit browser proof gate before any connected automation work.",
    ],
  },
  {
    channel: "costar_loopnet",
    label: "CoStar / LoopNet",
    defaultTier: "top_up",
    automationMode: "posting_assist",
    sourceLevel: "official",
    sourceRefs: [
      "https://www.costar.com/en-ca/can/campaign/whylist-owners",
      "https://broker-ownerhelp.loopnet.com/article/761-do-you-have-to-be-a-broker-to-advertise-on-loopnet",
      "https://www.loopnet.com/search/apartment-buildings/usa/for-sale/",
      "https://www.costar.com/campaign/owners/multifamily",
      "https://www.loopnet.com/solutions/",
      "https://www.costar.com/products/listings",
    ],
    verifiedOn: "2026-08-27",
    required: [
      "address",
    ...
    operatorSteps: [
      ...
      "Confirm whether the path is a free CoStar owner listing or a paid LoopNet marketing product before continuing.",
      "Stop for explicit approval before any paid package, subscription, or marketing placement.",
      "Save the public LoopNet or CoStar listing URL back into Vacantless after proof exists.",
    ],
    topUps: [
      "LoopNet marketing package, only with explicit approval",
      "CoStar subscription or listing product, only with explicit approval",
    ],
    proofRequired: true,
    liveProofLabel: "LoopNet or CoStar public listing URL",
    notes: [
      "LoopNet help says owners, developers, property managers, brokers, and authorized representatives can advertise directly, but may need to verify credentials.",
      "LoopNet publicly lists apartment buildings and multifamily properties, including small 5+ unit investment listings, so this lane is not limited to office/retail/industrial inventory.",
      "CoStar owner-facing Canada copy says owners can list on CoStar without requiring a paid subscriber account; LoopNet marketing products and paid packages stay separate approval gates.",
    ],
  },
  {
    channel: "realtor_ca",
